...
class SettingValuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create setting_value" do
    assert_difference('SettingValue.count') do
      post setting_values_url, params: { setting_value: { setting_list: @setting_value.setting_list, value: @setting_value.value } }
    end
  ...
  test "should update setting_value" do
    patch setting_value_url(@setting_value), params: { setting_value: { setting_list: @setting_value.setting_list, value: @setting_value.value } }
