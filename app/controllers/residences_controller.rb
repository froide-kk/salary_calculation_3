class ResidencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @residence.save
        format.html { redirect_to '/admin/setting', notice: 'Residence was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @residence.update(residence_params)
        format.html { redirect_to '/admin/setting', notice: 'Residence was successfully updated.' }
  ...
  def destroy
    @residence.destroy
    respond_to do |format|
      format.html { redirect_to "/admin/setting", notice: 'Residence was successfully destroyed.' }
  ...
  private
    ...
    def residence_params
      params.require(:residence).permit(:name, :price)
    end
end
