class MemberTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @member_type.save
        format.html { redirect_to '/admin/setting', notice: 'Member type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @member_type.update(member_type_params)
        format.html { redirect_to '/admin/setting', notice: 'Member type was successfully updated.' }
  ...
  def destroy
    @member_type.destroy
    respond_to do |format|
      format.html { redirect_to "/admin/setting", notice: 'Member type was successfully destroyed.' }
  ...
  private
    ...
    def member_type_params
      params.require(:member_type).permit(:name, :price)
    end
end
