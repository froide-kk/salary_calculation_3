...
class AdjustmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adjustment" do
    assert_difference('Adjustment.count') do
      post adjustments_url, params: { adjustment: { adjustment_type_id: @adjustment.adjustment_type_id, count: @adjustment.count, date: @adjustment.date, personal_information_id: @adjustment.personal_information_id } }
    end
  ...
  test "should update adjustment" do
    patch adjustment_url(@adjustment), params: { adjustment: { adjustment_type_id: @adjustment.adjustment_type_id, count: @adjustment.count, date: @adjustment.date, personal_information_id: @adjustment.personal_information_id } }
