...
class PositionGradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create position_grade" do
    assert_difference('PositionGrade.count') do
      post position_grades_url, params: { position_grade: { add_amount: @position_grade.add_amount, base_age: @position_grade.base_age, job_ability_grade: @position_grade.job_ability_grade, position_ID: @position_grade.position_ID, position_name: @position_grade.position_name, task_grade: @position_grade.task_grade, task_time: @position_grade.task_time } }
    end
  ...
  test "should update position_grade" do
    patch position_grade_url(@position_grade), params: { position_grade: { add_amount: @position_grade.add_amount, base_age: @position_grade.base_age, job_ability_grade: @position_grade.job_ability_grade, position_ID: @position_grade.position_ID, position_name: @position_grade.position_name, task_grade: @position_grade.task_grade, task_time: @position_grade.task_time } }
