...
class ResidencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create residence" do
    assert_difference('Residence.count') do
      post residences_url, params: { residence: { name: @residence.name, price: @residence.price } }
    end
  ...
  test "should update residence" do
    patch residence_url(@residence), params: { residence: { name: @residence.name, price: @residence.price } }
