...
class AgeGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create age_group" do
    assert_difference('AgeGroup.count') do
      post age_groups_url, params: { age_group: { age: @age_group.age, age_adjustment: @age_group.age_adjustment, age_point: @age_group.age_point, date: @age_group.date, personal_information_id: @age_group.personal_information_id } }
    end
  ...
  test "should update age_group" do
    patch age_group_url(@age_group), params: { age_group: { age: @age_group.age, age_adjustment: @age_group.age_adjustment, age_point: @age_group.age_point, date: @age_group.date, personal_information_id: @age_group.personal_information_id } }
