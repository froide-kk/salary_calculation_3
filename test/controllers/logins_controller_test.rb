...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { user_id: @login.user_id, user_pw: @login.user_pw } }
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { user_id: @login.user_id, user_pw: @login.user_pw } }
