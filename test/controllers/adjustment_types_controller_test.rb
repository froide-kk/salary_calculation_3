...
class AdjustmentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adjustment_type" do
    assert_difference('AdjustmentType.count') do
      post adjustment_types_url, params: { adjustment_type: { hint: @adjustment_type.hint, name: @adjustment_type.name, value: @adjustment_type.value } }
    end
  ...
  test "should update adjustment_type" do
    patch adjustment_type_url(@adjustment_type), params: { adjustment_type: { hint: @adjustment_type.hint, name: @adjustment_type.name, value: @adjustment_type.value } }
